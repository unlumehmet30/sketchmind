...
class _PromptScreenState extends State<PromptScreen> {
  late final OpenAIStoryService _storyService; // ✅ initState'te oluşturulacak
  ...
  void initState() {
    super.initState();
    _storyService = OpenAIStoryService(); // ✅ dotenv artık yüklendi varsayılır
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                const Expanded(child: Text('İnternet bağlantısı yok! Lütfen kontrol edin.')),
              ],
            ),
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                const SizedBox(width: 10),
                const Expanded(child: Text('Hikaye başarıyla oluşturuldu!')),
              ],
            ),
          ...
          SnackBar(
            content: Row(
              children: [
                SizedBox(width: 30, height: 30, child: Lottie.asset('assets/lottie/error_sad.json', repeat: false)), 
                const SizedBox(width: 10),
                const Expanded(child: Text('Hata oluştu: Hikaye oluşturulamadı. (API Anahtarını/Konsolu kontrol edin)')),
              ],
            ),
            duration: const Duration(seconds: 4),
          ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Hayalini Anlat")),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: _isProcessing
                  ? SizedBox(width: 100, height: 50, child: Lottie.asset('assets/lottie/loading_rocket.json', repeat: true))
